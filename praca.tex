...
języka \emph{Sass}\footnote{Syntactically Awesome Stylesheets}. Język
\emph{Sass} jest metajęzykiem, służącym do opisu kaskadowych arkuszy
stylów \emph{CSS}. Najważniejsze zalety języka \emph{Sass} to:

\begin{itemize}
%\item zmniejszenie liczby powtórzeń w kodzie
...
planszy do gry wyłącznie za pomocą arkuszy stylów.
