...
\subsection{Serwer}
Do zaimplementowania tej części aplikacji zostanie wykorzystany język
\emph{Ruby} i framework \emph{Ruby on Rails}. Wybór można uzasadnić
bardzo dobrym wsparciem frameworka dla architektury \emph{REST}, która
zostanie wykorzystana do stworzenia \emph{API}.
...
\emph{Netscape}, jako język zastępujący wbudowaną w przeglądarki
\emph{Javę}. Jego twórcą jest amerykański programista Brendan Eich.
Począwszy od 1996 roku język jest standaryzowany przez \emph{ECMA
  International}\footnote{ECMA (ang. European association for
...
zapożyczył od niej zestaw słów kluczowych i w niewielkim stopniu
składnię. Ta prosta marketingowa sztuczka zaowocowała całkowitym
niezrozumieniem tego języka przez programistów, którzy przez wiele lat
traktowali go jako pewien podzbiór języka \emph{Java}. W
rzeczywistości, język \emph{JavaScript} jest dużo bardziej
spokrewniony z językami funkcyjnymi, takimi jak \emph{Lisp}.
