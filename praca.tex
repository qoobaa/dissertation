...
POST /games
\end{verbatim}
\item wyświetlenie gry w domyślnym formacie (\emph{HTML})
\begin{verbatim}
GET /games/1
\end{verbatim}
\item wyświetlenie gry w formacie \emph{JSON}
\begin{verbatim}
GET /games/1.json
\end{verbatim}
\item wyświetlenie listy gier
\begin{verbatim}
GET /games
\end{verbatim}
...
\end{verbatim}
\item kupowanie karty rozwoju
\begin{verbatim}
POST /games/1/cards
\end{verbatim}
\item zagrywanie karty rozwoju
\begin{verbatim}
PUT /games/1/cards/1
...
\end{verbatim}
\item wymiana zasobów z bankiem
\begin{verbatim}
...
offer[wool]=-1
\end{verbatim}
\item akceptowanie oferty handlu
\begin{verbatim}
PUT /games/1/offer
offer[state_event]=accept
offer[recipient_number]=3
\end{verbatim}
\item odrzucanie oferty handlu
\begin{verbatim}
PUT /games/1/offer
offer[state_event]=decline
\end{verbatim}
\item tworzenie odpowiedzi na ofertę handlu
\begin{verbatim}
...
POST /games/1/player
\end{verbatim}
\item odłączanie się z gry
\begin{verbatim}
DELETE /games/1/player
\end{verbatim}
\item tworzenie ,,rabunku''
\begin{verbatim}
