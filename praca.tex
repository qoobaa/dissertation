...
Osiągnięte zostały najważniejsze cele projektowe. Po zalogowaniu się
do serwisu, użytkownik ma możliwość utworzenia nowej gry i dołączenia
do niej. Do tworzenia losowych planszy zaimplementowany został również
prosty generator plansz, którego algorytm działania zbliżony jest do
oryginalnych zasad gry. Zalogowani użytkownicy mają oczywiście
...
projektu okazało się zaimplementowanie części klienckiej
aplikacji. Fakt ten spowodowany jest przez się kilka różnych
czynników. Język \emph{JavaScript} jest dość specyficznym językiem
programowania, który w pewnych kwestiach (w szczególności w kwestii
dziedziczenia prototypowego) znacząco różni się od popularnych
rozwiązań i często wymaga od programisty zmiany sposobu
myślenia. Wykorzystana w projekcie biblioteka \emph{YUI3} znajduje się
ciągle w fazie dynamicznego rozwoju, jest ona również stosunkowo mało
...
\item zaprojektowanie przyjaznego dla użytkownika interfejsu
  graficznego
\item dodanie tzw. czatu, umożliwiającego komunikację między graczami
\item
\end{itemize}
