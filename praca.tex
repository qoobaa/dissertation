...
\item \texttt{discard} - faza odrzucania nadmiarowych zasobów, w czasie
  ...
  przejście do fazy \texttt{robber}
\item \texttt{robber} - podczas tej fazy gry, należy przesunąć pionek
  ...
  \texttt{before roll} lub \texttt{after roll}, w zależności od tego, czy
...
\begin{itemize}
\item \texttt{players} - przechowuje informacje o graczach -
