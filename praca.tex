...
aplikacji. Pierwsze ,,jednoekranowe'' aplikacje, nie wymagające od
użytkownika przeładowywania dokumentu, wykorzystywały dodatkowe
...
ogłoszenia przez \emph{Microsoft} rozpoczęcia prac nad \emph{Office
  Web Apps}. Pomimo promowania przez firmę \emph{Microsoft}
rozwiązania konkurencyjnego dla \emph{Adobe Flash} -- technologii
\emph{Microsoft Silverlight}, wszystkie aplikacje opracowywane w
ramach projektu \emph{Microsoft Office Web Apps} w założeniu mają
wymagać od użytkownika wyłącznie przeglądarki
...
możliwe jest zaimplementowanie nawet skomplikowanej gry sieciowej,
mając do dyspozycji wyłącznie funkcje współczesnych przeglądarek
internetowych. Dzięki takiemu podejściu, dużo prostsze jest
przystosowanie gry do działania np. w urządzeniach mobilnych.

\section{Cel pracy}
Celem pracy jest stworzenie serwisu umożliwiającego rozgrywanie
wieloosobowych partii w grę planszową ,,Osadnicy z Catanu''. Aplikacja
ma umożliwiać prowadzenie wielu rozgrywek w tym samym czasie, dzięki
tworzeniu tzw. stołów, podobnie jak w serwisie \url{kurnik.pl}. Część
serwerowa aplikacji ma być stworzona w oparciu o framework \emph{Ruby
  on Rails}. Komunikacja serwera z klientem ma się odbywać zgodnie z
zasadami \emph{REST}\footnote{REST - ang. Representational State
  Transfer}, co nie wprowadza żadnych ograniczeń dla technologii
użytej w części klienckiej. Jednakże jej podstawowa implementacja
wykorzystywać ma wyłącznie możliwości współczesnych przeglądarek
internetowych, bez użycia dodatkowych technologii, takich jak
\emph{Adobe Flash} czy \emph{Java}.
