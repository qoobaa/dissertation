...
\texttt{<div>}. Pierwszy z nich, nazwany z ang. \emph{Bounding Box},
ułatwia tworzenie efektów, takich jak zaokrąglone krawędzie i
cienie. Drugi, tzw. \emph{Content Box} obejmuje właściwą zawartość
...
\begin{itemize}
\item \texttt{Game} - odpowiedzialny za tworzenie pozostałych
  kontrolek, przechwytywanie zdarzeń i komunikację z serwerem
...
\begin{figure}[ht]
  \begin{center}
    \begin{tabular}{|c|c|}
      \hline
      \subfloat{\label{fig:afterrollwidget}}\includegraphics[scale=0.5]{afterrollwidget.png}
      &
      \subfloat{\label{fig:beforerollwidget}}\includegraphics[scale=0.5]{beforerollwidget.png}
      \\
      \hline
      \subfloat{\label{fig:buildwidget}}\includegraphics[scale=0.5]{buildwidget.png}
      &
      \subfloat{\label{fig:cardswidget}}\includegraphics[scale=0.5]{cardswidget.png}
      \\
      \hline
      \subfloat{\label{fig:discardwidget}}\includegraphics[scale=0.5]{discardwidget.png}
      &
      \subfloat{\label{fig:exchangewidget}}\includegraphics[scale=0.5]{exchangewidget.png}
      \\
      \hline
      \subfloat{\label{fig:offerwidget}}\includegraphics[scale=0.5]{offerwidget.png}
      &
      \subfloat{\label{fig:joinwidget}}\includegraphics[scale=0.5]{joinwidget.png}
      \\
      \hline
      \subfloat{\label{fig:offerreceivedwidget}}\includegraphics[scale=0.5]{offerreceivedwidget.png}
      &
      \subfloat{\label{fig:offersentwidget}}\includegraphics[scale=0.5]{offersentwidget.png}
      \\
      \hline
      \subfloat{\label{fig:userplayerwidget}}\includegraphics[scale=0.5]{userplayerwidget.png}
      &
      \subfloat{\label{fig:playerswidget}}\includegraphics[scale=0.5]{playerswidget.png}
      \\
      \hline
      \subfloat{\label{fig:gamestatuswidget}}\includegraphics[scale=0.5]{gamestatuswidget.png}
      & \\
      \hline
    \end{tabular}
  \end{center}
...
Jako, że jednym z głównych założeń projektowych jest możliwość
dostosowania aplikacji do wymagań stawianych przez urządzenia mobilne,
komunikacja z serwerem została oparta o tradycyjny \emph{Ajax}
(\emph{HTTP Pull}). Opóźnienia wynikające z użycia tego rozwiązania
nie stanowią większego problemu w przypadku implementacji gier
turowych. Cykliczne pobieranie danych gry w kilkusekundowych odstępach
jest zupełnie wystarczające z punktu widzenia użytkownika, nie
wprowadza również nadmiernego obciążenia serwera gry.
...
\begin{itemize}
\item numerze gracza należącym do użytkownika
...
automatyzostał tę czynność, wyświetlając żądane informacje. Sytuacja
...
Zastosowanie formatu \emph{JSON}
