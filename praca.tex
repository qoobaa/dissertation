...
Społeczność \emph{Ruby on Rails} położyła duży nacisk na zwiększenie
czytelności testów integracyjnych. Jest to spowodowane faktem, iż
często kod testów, pisany zwykle przed właściwym kodem, wykorzystywany
jest jako jego specyfikacja. Jednym z ciekawszych rozwiązań, służących
do pisania testów integracyjnych, jest biblioteka
\emph{Cucumber}. Testy zapisywane są w postaci historyjek użytkownika
w zwykłym tekście, który następnie przetwarzany jest przy pomocy
wyrażeń regularnych. Po zdefiniowaniu wyrażeń regularnych i kodu
odpowiedzialnego za wykonywanie tzw. kroków, testy uruchamiane są w
jednym z następujących środowisk:
...
wykorzystanie do testów tradycyjnej przeglądarki
internetowej. Zastosowanie bibliotek \emph{Selenium} lub \emph{Watir},
pociąga za sobą następujące konsekwencje:
...
% przysłaniają korzyści płynące z zastosowania testów
% zrezygnowano z testów integracyjnych aplikacji
