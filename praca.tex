...
został również prosty generator plansz, którego algorytm działania
zbliżony jest do oryginalnych zasad gry. Zalogowani użytkownicy mają
oczywiście możliwość dołączenia do gier, które nie zostały jeszcze
rozpoczęte. Po zgromadzeniu odpowiedniej liczby graczy możliwe jest
...
błędu) możliwe jest przeładowanie dokumentu, czego konsekwencją jest
ponowne uruchomienie aplikacji.

Mocną stroną aplikacji jest przechowywanie stanu gry w bazie danych,
co w znaczącym stopniu uodparnia aplikację na błędy i awarie. Dzięki
temu konieczność zrestartowania serwera aplikacji nie powoduje utraty
...
Przed uruchomieniem ogólnodostępnego serwisu z grą ,,Osadnicy z
